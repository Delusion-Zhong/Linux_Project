...
//  * @return T* 分配的内存指针，失败返回nullptr
//  *
//  * 分配流程：
//  * 1. 加锁保护共享资源
//  * 2. 在FreeSpans_中查找合适大小的Span
//  * 3. 如果找到，可能需要分割Span
//  * 4. 如果没找到，向系统申请新内存
//  * 5. 记录分配信息到SpanMap_
//  */
// template <typename T, typename N>
// T *PageCache::allocateSpan(N numPages)
// {
...
//     T *memory = systemAlloc<N>(numPages);
//     if (!memory)
//     {
//         return nullptr;
//     }
...
//  */
// template <typename T, typename N>
// void PageCache::deallocateSpan(T *ptr, N numPages)
// {
//     std::lock_guard<std::mutex> lock(mutex_);
//     // 查找和ptr 对应的span
...
//  */
// template <typename T, typename N>
// T *PageCache::systemAlloc(N numPages)
// {
//     // 计算需要分配的总字节数
